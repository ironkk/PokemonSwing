 ...
 * @author DAM
 */
public class VerPokemonPlanta extends javax.swing.JDialog {

    /**
     * Creates new form VerPokemonPlanta
     */
    public VerPokemonPlanta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("VER POKEMON PLANTA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerPokemonPlanta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VerPokemonPlanta dialog = new VerPokemonPlanta(new javax.swing.JFrame(), true);
