 ...
 * @author DAM
 */
public class VerPokemonFuego extends javax.swing.JDialog {

    /**
     * Creates new form VerPokemonFuego
     */
    public VerPokemonFuego(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerPokemonFuego.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VerPokemonFuego dialog = new VerPokemonFuego(new javax.swing.JFrame(), true);
