...
public class Totales extends javax.swing.JDialog {
    ...
    public Totales(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    //    jTextField1.setText(misPokemons.);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nº TOTAL POKEMONS");

        jLabel4.setText("Tipo Agua");
        ...
        jLabel7.setText("Pokemons");

        jTextField3.setEditable(false);
        jTextField3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N

        jLabel8.setText("Tipo Planta");

        jLabel9.setText("Pokemons");
